...
public class AuthController {
    ...
    public ResponseEntity<LoginResponseDto> verifyEmail(@RequestBody @Valid VerifyOtpRequestDto verifyOtpRequestDto) {
        LoginResponseDto response = authService.verifyEmailOtp(verifyOtpRequestDto);
        return ResponseEntity.ok(response);
    }

    @PostMapping("/resend-verification-otp")
    public ResponseEntity<Map<String, String>> resendVerificationOtp(@RequestBody @Valid ResendOtpRequestDto requestDto) {
    ...
    public ResponseEntity<Map<String, String>> forgotPassword(@RequestBody @Valid ForgotPasswordRequestDto requestDto) {
    ...
    public ResponseEntity<Map<String, String>> resetPassword(@RequestBody @Valid ResetPasswordRequestDto requestDto) {
    ...
    @PostMapping("/refresh")
    public ResponseEntity<String> refreshToken(@RequestBody @Valid RefreshTokenRequestDto refreshTokenRequestDto) {
